...
public class JewelViewer extends Application {
    ...
    private static final String MESH_FILENAME =
            "/Users/finleycrowther/3dModels/Cac.stl";
...
//        return new MeshView[] { new MeshView(mesh) };
    ...
    private Group buildScene() {
        ...
        for (int i = 0; i < meshViews.length; i++) {
            meshViews[i].setTranslateX((double) VIEWPORT_SIZE / 2 + MODEL_X_OFFSET);
            meshViews[i].setTranslateY((double) VIEWPORT_SIZE / 2 + MODEL_Y_OFFSET);
            meshViews[i].setTranslateZ((double) VIEWPORT_SIZE / 2);
        ...
        pointLight.setTranslateX((double) (VIEWPORT_SIZE * 3) /4);
        pointLight.setTranslateY((double) VIEWPORT_SIZE /2);
        pointLight.setTranslateZ((double) VIEWPORT_SIZE /2);
        PointLight pointLight2 = new PointLight(lightColor);
        pointLight2.setTranslateX((double) (VIEWPORT_SIZE) /4);
        pointLight2.setTranslateY((double) (VIEWPORT_SIZE * 3) /4);
        pointLight2.setTranslateZ((double) (VIEWPORT_SIZE * 3) /4);
        PointLight pointLight3 = new PointLight(lightColor);
        pointLight3.setTranslateX((double) (VIEWPORT_SIZE * 5) /8);
        pointLight3.setTranslateY((double) VIEWPORT_SIZE /2);
